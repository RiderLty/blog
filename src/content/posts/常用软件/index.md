...
description: '常用软件的介绍与下载存档'
image: './cover.png'
tags: [software,direct-link]
category: 'software'
draft: false 
lang: ''
---
...
## 7zip
7-Zip 是一个开源的文件压缩工具，支持多种压缩格式，包括但不限于 ZIP、RAR、7Z 等。它是一个功能强大且免费的工具。
- [官方网站](https://www.7-zip.org/)
- [直接下载链接](https://www.7-zip.org/a/7z2501-x64.exe)

## Everything
Everything 是 Windows 上一款搜索引擎，它能够基于文件名快速定文件和文件夹位置。
- [官方网站](https://www.voidtools.com/zh-cn/)
- [直接下载链接](https://www.voidtools.com/Everything-1.4.1.1030.x64-Setup.exe)

## Anytxt
Anytxt 支持通过关键词全盘搜索文件内容，而不是仅搜索文件名。
- [直接下载链接](https://sourceforge.net/projects/anytxt/files/Anytxt_1.3.2477_Windows_X86_64.exe/download)
...
具体命令列表请参考安装后设置界面的帮助对话框。而且同一个快捷键能在不同网站上分别触发各自的命令，也可以基于当前键盘焦点处的页面元素来触发不同命令。
- [直接下载链接](https://microsoftedge.microsoft.com/addons/detail/vimium-c-%E5%85%A8%E9%94%AE%E7%9B%98%E6%93%8D%E4%BD%9C%E6%B5%8F%E8%A7%88%E5%99%A8/aibcglbfblnogfjhbcmmpobjhnomhcdo)

## Quicker
Quicker是一款可以为任何常用内容建立捷径，让计算机自动工作的软件。您可以通过鼠标、键盘、轮盘菜单等多种方式触发动作，还可以分享和使用其他用户的动作。
- [官方网站](https://www.getquicker.net/)
- [直接下载链接](https://download.getquicker.net/_productfiles/202511/Quicker.x64.1.44.31.0.msi)
...
- [官方网站](https://github.com/es3n1n/no-defender)
- [直接下载链接](https://1833788059.v.123pan.cn/1833788059/direct/%E5%B8%B8%E7%94%A8/no-defender_win_x64.zip)
